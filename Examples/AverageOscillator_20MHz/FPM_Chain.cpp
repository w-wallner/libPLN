...
TdEstimatorConfig
TdOracle_AvgOsc20MHz::TdEstChain_FPM::GetConfig_FPM_20MHz(unsigned int Seed, bool EnableIntervalSkipping)
{
    ...
    config.PLN_FilterConf.Qd                = 1.77743983746859E-5;
...
TdEstimatorConfig
TdOracle_AvgOsc20MHz::TdEstChain_FPM::GetConfig_FPM_1MHz(unsigned int Seed, bool EnableIntervalSkipping)
{
    TdEstimatorConfig   config;
    ...
    config.PLN_FilterConf.Qd                = 5.37675550834249E-8;
    config.PLN_FilterConf.alpha             = FSA::ALPHA_FPM;
    config.PLN_FilterConf.FilterLen         = 10;
    config.PLN_FilterConf.Seed              = Seed;
...
TdEstimatorConfig
TdOracle_AvgOsc20MHz::TdEstChain_FPM::GetConfig_FPM_10kHz(unsigned int Seed, bool EnableIntervalSkipping)
{
    TdEstimatorConfig   config;
    ...
    config.PLN_FilterConf.Qd                = 4.44359959367147E-12;
    config.PLN_FilterConf.alpha             = FSA::ALPHA_FPM;
    config.PLN_FilterConf.FilterLen         = 10;
    config.PLN_FilterConf.Seed              = Seed;
...
TdEstimatorConfig
TdOracle_AvgOsc20MHz::TdEstChain_FPM::GetConfig_FPM_100Hz(unsigned int Seed, bool EnableIntervalSkipping)
{
    TdEstimatorConfig   config;
    ...
    config.PLN_FilterConf.Qd                = 4.44359959367147E-16;
    config.PLN_FilterConf.alpha             = FSA::ALPHA_FPM;
    config.PLN_FilterConf.FilterLen         = 10;
    config.PLN_FilterConf.Seed              = Seed;
...
{
    AddTdEstimator( GetConfig_FPM_20MHz( Seed + SeedOffset + 0, EnableIntervalSkipping ) );
    AddTdEstimator( GetConfig_FPM_1MHz ( Seed + SeedOffset + 1, EnableIntervalSkipping ) );
    AddTdEstimator( GetConfig_FPM_10kHz( Seed + SeedOffset + 2, EnableIntervalSkipping ) );
